...
public class AmazonSeleniumWaitDemo {
	...
	public static void seleniumWaits() {
		...
		driver.findElement(By.id("twotabsearchtextbox")).sendKeys("bluetoothspeaker");
		//driver.findElement(By.xpath("//*[@id=\"twotabsearchtextbox\"]")).sendKeys("bluetooth speaker");
